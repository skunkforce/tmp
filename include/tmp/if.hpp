#ifndef OSF_TMP_IF_HPP_INCLUDED
#define OSF_TMP_IF_HPP_INCLUDED

#include "vocabulary.hpp"

#if defined(__has_builtin)
#if __has_builtin(__type_pack_element)
#define OSF_TMP_USE_TYPE_PACK_ELEMENT_INTRINSIC
#endif
#endif
	...
	namespace tmp {
		...
		namespace detail {
			...
			struct dispatch<1, if_<lift_<P>, listify_, always_<list_<>>>> {
				template <typename U>
#if defined(OSF_TMP_USE_TYPE_PACK_ELEMENT_INTRINSIC)
